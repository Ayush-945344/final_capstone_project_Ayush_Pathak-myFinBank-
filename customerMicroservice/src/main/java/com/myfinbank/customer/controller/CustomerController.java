...
//	}
	...
	// account details
		...
		public ModelAndView  showAccountDetails(Model model, HttpSession session,@ModelAttribute("account") AccountDTO accountDto ) {
...
//	}
	...
	public String deposit(@RequestParam Long accountId, @RequestParam Double amount, Model model) {
		...
		return "redirect:/api/customer/dashboard"; // Redirect after deposit
	}
	...
	public String withdraw(@RequestParam Long accountId, @RequestParam Double amount, Model model) {
		...
		return "redirect:/api/customer/dashboard"; // Redirect after withdrawal
	}
	...
	public String transfer(@RequestParam Long fromAccountId, @RequestParam Long toAccountId,
		...
		return "redirect:/api/customer/dashboard"; // Redirect after transfer
	}
	...
	public String getTransactionHistory(@RequestParam Long accountId, Model model) {
		...
		return "view-transactions"; // Return the name of the JSP file
	}
